...
public class Main_to_show_second_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_to_show_second2);
        //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    private void getmodel(String wordcatch)
    {
        ...
        if(wordcatch.equals(""))
        {
            ...
            model=db.getDictmodel(wordcatch);
            String result = "";
            if(model == null)
            {
